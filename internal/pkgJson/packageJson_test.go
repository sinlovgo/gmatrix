	...
	jsonInfo = `
{
  ...
  "author": {
    "name": "sinlovgo",
    "email": "sinlovgogmppt@gmail.com",
    "url": "https://github.com/sinlovgo/gmatrix"
  }
}
`
	jsonInfoGoStyle = `
{
  ...
  "homepage": "https://github.com/sinlovgo/gmatrix#readme"
}
`
)
...
func TestGetPackageJsonAuthor(t *testing.T) {
	...
	assert.Equal(t, "sinlovgo", GetPackageJsonAuthor().Name)
	assert.Equal(t, "sinlovgogmppt@gmail.com", GetPackageJsonAuthor().Email)
}
...
func TestGetPackageJsonHomepage(t *testing.T) {
	...
	InitPkgJsonContent(jsonInfoGoStyle)
	assert.Equal(t, "https://github.com/sinlovgo/gmatrix#readme", GetPackageJsonHomepage())
}
